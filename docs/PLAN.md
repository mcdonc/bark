...
- **Update Dart dependencies**: Many Flutter/Dart packages have newer versions available (go_router, google_fonts, desktop_drop, etc.). Run `flutter pub outdated` and update where possible.
