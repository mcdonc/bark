...
- **Show logged-in email in app bar**: Display the current user's email address in the top bar (workspaces list and workspace pages). The email is already in the JWT payload (`email` claim) and accessible via `AuthService`.
